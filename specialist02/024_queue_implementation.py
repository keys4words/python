...
names = ['Mary', 'James', 'Mark', 'Ann', 'Paul']
# winner = hot_potato(names, 5)
# print(f'Winner is {winner}')

lst = ['9 Ivanov', '10 Petrov', '11 Sidorov', '9 Morozov', '9 Belov', '10 Nikitin']
...
rs = RadixSort(nums)
print('Before sorting:', rs.show())
rs.distribute(1)
rs.collect()
print('Middle sorting:', rs.show())
rs.distribute(10)
rs.collect()
print('After sorting:', rs.show())
